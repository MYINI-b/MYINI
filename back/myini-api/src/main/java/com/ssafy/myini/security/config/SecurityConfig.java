...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/api/initializers/downloads","/api/initializers/app", "/api/initializers/{projectid}", "/api/initializers/settings").permitAll()
                .antMatchers(HttpMethod.PATCH,"/api/initializers/app").permitAll()
